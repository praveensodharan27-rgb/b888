...
| GET | `/api/users/:id/public-profile` | No | Get public profile by ID (alternative) |
...
## 💳 PAYMENT GATEWAY (`/api/payment-gateway`)
...
## 💼 BUSINESS PACKAGES (`/api/business-package`)
...
| GET | `/api/session/admin/user/:userId` | Admin | Get sessions for user (admin) |
...
- **Complete A-Z:** `COMPLETE_API_ENDPOINTS_A_TO_Z.md`
- **Quick Reference:** `API_ENDPOINTS_QUICK_REFERENCE.md`
- **Missing Endpoints:** `MISSING_ENDPOINTS_ADDED.md`
